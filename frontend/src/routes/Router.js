...
const ProctoringReportsPage = Loadable(lazy(() => import('./../views/teacher/ProctoringReportsPage')));
      ...
      <Route path="" element={<PrivateRoute />}>
        ...
        <Route path="/" element={<FullLayout />}>
          ...
          <Route path="" element={<TeacherRoute />}>
            ...
            <Route path="/proctoring-reports" exact={true} element={<ProctoringReportsPage />} />
          </Route>
        </Route>
