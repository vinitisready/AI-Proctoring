...
import proctoringReportRoutes from "./routes/proctoringReportRoutes.js";
...
// Test route for proctoring reports
app.get("/api/test-proctoring", (req, res) => {
  res.json({ message: "Proctoring API is working!", timestamp: new Date() });
});
...
app.use("/api/proctoring-report", proctoringReportRoutes);
